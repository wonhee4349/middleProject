...
<script src="<%=request.getContextPath()%>/js/community.js" type="text/javascript"></script>
					...
					<div class="wrap">
						...
						<!-- 상세정보 -->
							...
							<div class="bottom_btn_wrap">
								...
								<input type="button" class="blue_btn btn" value="취소" onClick="location.href='<%=request.getContextPath()%>/qaList.do'">
							</div>
							</form>
