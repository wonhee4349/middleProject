...
$(function(){
	...
	$('#btn_login').on('click',function(){
		...
		$.ajax({
			...
			url:"<%=request.getContextPath()%>/pwFindMember.do",
			data:{
				"id":inputId,
				"mail":inputMail
			},
			...
			success: function(res){
				if(res.ss=="전송실패"){
					$('#spanid').text('● 전송실패!! 아이디 또는 이메일을 잘못 입력했습니다.');
...
<body class="main">
	...
	<div id="wrap">
		...
		<div class="area_subVisual">
			...
			<div class="subTit">
				<div>
					<h2 data-aos="fade-up">비밀번호 찾기</h2>
				</div>
				<div>
					...
					<div class="wrap">
						...
						<div class="join_area">
							<div class="box join">
								...
								<form method='post' action="<%=request.getContextPath() %>/pwFindMember.do">
									
									<input type="hidden" name="mode" value="login_proc" />
									<ul class="designValue">
										<li data-member-login="id" data-member-form="id">
										<label for="id">아이디</label>
										<input type="text" id="id" name="id" class="inputFull required" title="id" placeholder="id" /></li>
									...
									<input type="button" value="비밀번호찾기" class="btn_login" id="btn_login"/>
									<span id="spanid"></span>
