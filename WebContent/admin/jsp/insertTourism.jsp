...
%>                        
            ...
            <!-- End of Topbar -->
				...
				<form action="<%=request.getContextPath()%>/insertTourism.do" method="post" enctype="multipart/form-data">
							...
							<div class="table-responsive" id="showdetails">
									<table class="table table-bordered sytable" id="dataTable" cellspacing="0">
										...
										<tr>
											...
											<td class="tds">
												<input type="text" name="trAddr">
											</td>						
										</tr>
										<tr>
											<th class="syths">전화번호</th>
											<td class="tds">
												<input type="text" name="trTel">
											</td>							
										</tr>
										<tr>
											<th class="syths">위도</th>
											<td class="tds">
												<input type="text" name="trLat">
											</td>							
										</tr>
										<tr>
											<th class="syths">경도</th>
											<td class="tds">
												<input type="text" name="trLong">
											</td>					
										</tr>
										<tr>
											<th class="syths">첨부파일</th>
											<td class="tds">
												<input type="file" name="tr_origin_file_name">
											</td>
										</tr>
										<tr>
											<th class="syths">내용</th>	
											<td><textarea class="sytext" name="trCon"></textarea></td>												
										</tr>
										</tbody>
										</table>
							</div>
					...
					<a href="#">
						<span class="text"><input class="btpd btn btn-primary  btn-icon-split  mr10 f-right mb50" type="submit" value="저장"></span>
					</a>
					</form>
				</div>
				<!-- /.container-fluid -->
