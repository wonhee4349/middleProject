...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center"  href="<%=request.getContextPath()%>/admin/jsp/main_mg.jsp">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
					...
					<%
						if(inputId != null) {
					%>
					<a href="#" class="btn btn-primary  btn-icon-split  mr10"
						id="btn_logout"> <span class="text">로그아웃</span>
					</a>
					<%
						} else {
					%>
					<a href="<%=request.getContextPath()%>/admin/jsp/mglogin.jsp"
						class="btn btn-primary  btn-icon-split  mr10" id="write"> <span
						class="text">로그인</span>
					</a>
					<%
						}
...
%>
  ...
  <span class="mr-2 d-none d-lg-inline text-gray-600 small" style="color: red"; >로그인을해주세요</span>
