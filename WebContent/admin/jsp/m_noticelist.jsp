...
%>
    	...
    	$.ajax({
    		...
    		success:function(res){
    			...
    			code = `<table class='table table-bordered' id='dataTable' width='100%' cellspacing='0'>`
    				code+=`<tr style=text-align:center><th>번호</th><th>날짜</th> <th>제목</th> <th>작성자</th> </tr>`
				...
				$.each(res, function(i,v){
					...
					<%-- code += "<td><a href='<%=request.getContextPath()%>/admin/jsp/m_noticedetail.jsp?no=" + res[i].not_no + "'>" + res[i].not_title + "</a></td>";   --%>
					code += "<td><a href='<%=request.getContextPath()%>/admin/jsp/m_noticedetail.jsp?no=" + res[i].not_no + "&title=" + encodeURIComponent(res[i].not_title) + "&con=" + encodeURIComponent(res[i].not_con) + "'>" + res[i].not_title + "</a></td>";
    ...
    $('#write').on('click',function(){
    		...
    		location.href="<%=request.getContextPath()%>/admin/jsp/m_noticewrite.jsp"
            ...
            <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
		             ...
		             <a href="#" class="btn btn-primary  btn-icon-split  mr10" id="write" style="display:block; float:right;"> 
											  <span class="text">글쓰기</span> </a>
		               <!-- <button type="button" id="write" >글쓰기
			                        </button> -->
