...
%>                        
            ...
            <!-- End of Topbar -->
				...
				<form action="<%=request.getContextPath()%>/insertChatbot.do" method="post">

					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">관광정보</h1>
					<p class="mb-4">챗봇 관리 페이지입니다.</p>
						...
						<div class="card-body">
							...
							<div class="table-responsive" id="showdetails">
									<table class="table table-bordered sytable" id="dataTable" cellspacing="0">
										<tbody>
										<tr>
											<th class="syths">질문내용</th>
											<td class="tds">
												<input type="text" name="cbCon">
											</td>					
										</tr>
										<tr>
											<th class="syths">답변내용</th>
											<td class="tds">
												<input type="text" name="cbRp">
											</td>						
										</tr>
					...
					<a href="<%=request.getContextPath() %>/admin/jsp/chatbotMG.jsp"
						...
						<span class="text"><input class="btn btn-primary  btn-icon-split  mr10 f-right mb50" type="submit" value="저장"></span>
