...
<script>
	...
	$(function(){
		...
		$(document).on('click', '#updateRS', function(){
			...
			location.href = "/admin/jsp/restaurantModify.jsp?no=" + rsNo;
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<div class="restaurant-image" id="rsimage">
					...
					<button type="button" id="updateRS"
						class="btn btn-primary  btn-icon-split  mr10 f-right mb50 btpd" style="padding: 0.375rem 0.75rem !important;">수정</button>
					
					<button type="button" id="deleteRS"
						class="btn btn-primary  btn-icon-split  mr10 f-right mb50 btpd">삭제</button>
