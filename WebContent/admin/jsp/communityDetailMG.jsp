...
$(function(){
	$('#deleteBtn').on('click',function(){
		if(confirm("정말로 삭제하시겠습니까?")){
			location.href="<%=request.getContextPath() %>/deleteCommunity.do?cmtNo=<%=vo.getCmt_no()%>"
		}else{
			return;
		}
	})
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Community Information</h6>
						</div>
						...
						<div class="card-body">
							...
							<div class="table-responsive" id="showdetails">
									<table class="table table-bordered sytable" id="dataTable" cellspacing="0">
										...
										<tr>
											<th class="syths">글번호</th>
											<td class="tds"><%=vo.getCmt_no() %></td>						
										</tr>
										<tr>
											<th class="syths">제목</th>
											<td class="tds"><%=vo.getCmt_title() %></td>						
										</tr>
										<tr>
											<th class="syths">조회수</th>
											<td class="tds"><%=vo.getCmt_hit() %></td>							
										</tr>
										<tr>
											<th class="syths">작성일</th>
											<td class="tds"><%=vo.getCmt_date() %></td>							
										</tr>
										<tr>
											<th class="syths">내용</th>	
											<td><textarea class="sytext" disabled><%=vo.getCmt_con() %></textarea></td>												
										</tr>
										</tbody>
										</table>
							</div>
					...
					<a href="<%=request.getContextPath() %>/admin/jsp/communityMG.jsp"
						class="btn btn-primary  btn-icon-split  mr10 f-right mb50"> <span
						class="text">목록</span>
					</a>
