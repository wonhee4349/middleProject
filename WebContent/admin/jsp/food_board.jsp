...
%>
    ...
    <script>	    
    	...
    	$(function(){    		
    		...
    		//List클릭
        	$(document).on('click','.tourDetailMG',function(){
        		trNo = $(this).attr('id');
        		location.href = "<%= request.getContextPath()%>/restaurantDetailMG.do?trNo="+rsNo;
        	});//tourDetail 끝
            ...
            <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                    	...
                    	<a href="<%=request.getContextPath() %>/insertRestaurant.do" class="btn btn-primary  btn-icon-split  mr10 f-right mb50">
