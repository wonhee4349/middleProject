...
<%
    ...
    String inputNum = (String)session.getAttribute("LOGINUM");
    		
    		System.out.print("관리자 번호"+inputNum);
    ...
    $(function(){
    	...
    	$('#insert').on('click',function(){
    		...
    		var input_title=$('#title').val();
     		//var input_mnum=$('#mnum').val();
     		var input_con=$('#con').val();
     		
     		  if(input_title.length<1){
          		  alert("입력하지 않은 칸이 있습니다.");
          		  return false;
    		  }
     		  
     		 if(input_con.length<1){
         		  alert("입력하지 않은 칸이 있습니다.");
         		  return false;
   		  }
 			...
 			//alert("제목"+input_title)
    		
    	
    	$.ajax({
    		 url: "<%=request.getContextPath()%>/insertnotice.do?mnum=<%=inputNum%>",
    		type:'post',
    		data: {
    			"title":input_title,
    			//"mnum":input_mnum,
		                ...
		                <div class="card-body d-flex flex-column">
		                    <form class="quick-post-form">
		                        <div class="form-group">
		                            <input type="text" class="form-control" name="title" id="title" aria-describedby="emailHelp" placeholder="제목">
		                            <!--  <input type="text" class="form-control" name="mnum" id="mnum" aria-describedby="emailHelp" placeholder="관리자 번호"> -->
		                             
		                        </div>
		                        <div class="form-group">
		                            <textarea class="boardform" name="con" id="con" placeholder="글작성"></textarea>
		                        </div>
		                        <div class="btn_wrap">
