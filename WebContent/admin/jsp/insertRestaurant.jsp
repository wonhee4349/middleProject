							...
							<div class="table-responsive" id="showdetails">
									<table class="table table-bordered sytable" id="dataTable" cellspacing="0">
										...
										<tr>
											...
											<td class="tds">
												<input type="text" name="rsAddr">
											</td>						
										</tr>
										<tr>
											<th class="syths">전화번호</th>
											<td class="tds">
												<input type="text" name="rsTel">
											</td>							
										</tr>
										<tr>
											<th class="syths">위도</th>
											<td class="tds">
												<input type="text" name="rsLat">
											</td>							
										</tr>
										<tr>
											<th class="syths">경도</th>
											<td class="tds">
												<input type="text" name="rsLong">
											</td>					
										</tr>
										<tr>
											<th class="syths">첨부파일</th>
											<td class="tds">
												<input type="file" name="rs_origin_file_name">
											</td>
										</tr>
										<tr>
											<th class="syths">내용</th>	
											<td><textarea class="sytext" name="rsCon"></textarea></td>												
										</tr>
										</tbody>
										</table>
							</div>
