...
<head>
    ...
    <script src="<%=request.getContextPath()%>/admin/js/jquery-3.7.0.min.js"></script>
        ...
        <script src="<%=request.getContextPath()%>/admin/js/couponMG.js"  type="text/javascript"></script>
<%
...
%>
 <script>
    ...
    $(function(){
    	...
    	//List클릭
    	$(document).on('click','.couponDetailMG',function(){
    		cpNo = $(this).attr('id');
    		location.href = "<%= request.getContextPath()%>/couponDetailMG.do?cpNo="+cpNo;
    	});//tourDetail 끝
            ...
            <!-- End of Topbar -->
                ...
                <div class="container-fluid">
					...
					<div id="pageList"></div>		<!-- 페이지 출력////////////////// -->
                    	...
                    	<a href="<%=request.getContextPath()%>/insertCoupon.do" class="btn btn-primary  btn-icon-split  mr10 f-right mb50">
