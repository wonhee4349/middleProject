...
$(function(){
	$('#deleteBtn').on('click',function(){
		if(confirm("정말로 삭제하시겠습니까?")){
			location.href="<%=request.getContextPath() %>/deleteTourism.do?trNo=<%=vo.getTr_no()%>"
		}else{
			return;
		}
	})
...
%>                        
            ...
            <!-- End of Topbar -->
				...
				<div class="container-fluid">
						...
						<div class="card-body">
							...
							<div class="table-responsive" id="showdetails">
									<table class="table table-bordered sytable" id="dataTable" cellspacing="0">
										<tbody>
										<tr>
											<th class="syths">관광지 번호</th>
											<td class="tds"><%=vo.getTr_no() %></td>								
										</tr>
										<tr>
											<th class="syths">이름</th>
											<td class="tds"><%=vo.getTr_name() %></td>						
										</tr>
										<tr>
											<th class="syths">주소</th>
											<td class="tds"><%=vo.getTr_addr() %></td>							
										</tr>
										<tr>
											<th class="syths">전화번호</th>
											<td class="tds"><%=vo.getTr_tel() %></td>							
										</tr>
										<tr>
											<th class="syths">위도</th>
											<td class="tds"><%=vo.getTr_lat() %></td>							
										</tr>
										<tr>
											<th class="syths">경도</th>
											<td class="tds"><%=vo.getTr_long() %></td>					
										</tr>
										<tr>
					...
					<a href="<%=request.getContextPath() %>/updateTourism.do?trNo=<%=vo.getTr_no()%>"
