...
%>
 ...
 <script>
    ...
    $(function(){
    	...
    	//List클릭
    	$(document).on('click','.chatDetailMG',function(){
    		cbNo = $(this).attr('id');
    		location.href = "<%= request.getContextPath()%>/chatDetailMG.do?cbNo="+cbNo;
    	});//tourDetail 끝
            ...
            <!-- End of Topbar -->
                ...
                <div class="container-fluid">
					...
					<div id="pageList"></div>		<!-- 페이지 출력////////////////// -->
                    	...
                    	<a href="<%=request.getContextPath()%>/insertChatbot.do" class="btn btn-primary  btn-icon-split  mr10 f-right mb50">
